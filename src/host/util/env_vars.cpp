...
#define NVSHMEMI_OPTIONS_PRINT_ENV(NAME, KIND, DEFAULT, CATEGORY, SHORT_DESC,  \
                                   DESIRED_CAT, STYLE)                         \
  if (CATEGORY == DESIRED_CAT) {                                               \
    switch (STYLE) {                                                           \
      ...
      case NVSHMEMI_OPTIONS_STYLE_INFO:                                        \
        ...
        printf("  NVSHMEM_%-20s " NVSHPRI_##KIND                               \
               " (type: %s, default: " NVSHPRI_##KIND ")\n\t%s\n",             \
